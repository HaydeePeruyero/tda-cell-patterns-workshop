...
\begin{aligned}
\text{Imagen}
&\rightarrow \text{Segmentación celular}
\rightarrow \text{Coordenadas espaciales}
\rightarrow \text{Point Cloud} \
&\rightarrow \text{Complejo de Rips}
\rightarrow \text{Homología persistente}
\rightarrow \text{Diagramas de persistencia} \
&\rightarrow \text{Distancias de Wasserstein}
