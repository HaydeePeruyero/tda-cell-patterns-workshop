...
ruta = "https://raw.githubusercontent.com/HaydeePeruyero/tda-cell-patterns-workshop/main/data/"

archivos = [
    "carcinoma_FA_HN14_2.csv",
    "displasia_FA_HN14_2.csv",
    "stroma_FA_HN14_2.csv"
]

for archivo in archivos:

    # 1. Cargar archivo
    df = pd.read_csv( __________________ )

    # 2. Extraer coordenadas
    x = __________________
    y = __________________

    # 3. Construir nube de puntos
